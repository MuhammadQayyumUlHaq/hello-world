...
let usernames: string[] = ["admin", "john", "mary", "emma", "peter"];
...
// Define an array of usernames
let user_names: string[] = ["admin", "john", "mary", "emma", "peter"];
...
let current_users: string[] = ["john", "mary", "emma", "peter", "admin"];

// List of new usernames
let new_users: string[] = ["emma", "david", "sarah", "JOHN", "james"];
...
function make_album(artistName: string, albumTitle: string, numTracks?: number): { artist: string, title: string, tracks?: number } {
    let albumInfo: { artist: string, title: string, tracks?: number } = { artist: artistName, title: albumTitle };
...
const greatMagicions2:  string[] = makegreat(magicians3);
